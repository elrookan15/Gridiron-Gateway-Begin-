      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-800">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-lime-400 font-bold bg-lime-500/10 px-2 py-0.5 rounded border border-lime-500/30 flex items-center gap-1">
      ...
      <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 text-xs">
        ...
        <div className="flex items-center gap-3 bg-slate-900 px-3 py-2 rounded-xl border border-slate-800 shrink-0">
          ...
          <div className="text-center">
            ...
            <span className="font-extrabold text-lime-400 text-sm">+{totalBonusScore} pts</span>
          </div>
        </div>
      </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-1.5">
                      ...
                      {item.verified && (
                        <ShieldCheck className="w-4 h-4 text-lime-400 fill-lime-400/20" />
                      )}
                    </div>
