...
export const OnboardingWizard: React.FC<OnboardingWizardProps> = ({
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 text-white">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-lime-950 p-6 rounded-2xl border border-slate-800 shadow-xl mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 sm:p-6 mb-8">
        <div className="flex items-center justify-between text-xs font-bold text-slate-400 mb-2">
          ...
          <span className="text-lime-400">{progressPercent}% COMPLETE</span>
        </div>
        <div className="w-full h-2.5 bg-slate-800 rounded-full overflow-hidden mb-6">
          <div
            className="h-full bg-gradient-to-r from-lime-500 via-teal-400 to-lime-400 transition-all duration-300"
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center p-2.5 rounded-xl border text-center transition-all ${
                  isActive
                    ? "bg-lime-950/80 border-lime-500 text-lime-400 shadow-md shadow-lime-500/10"
                    : isDone
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-2xl mb-8">
          ...
          <div className="space-y-6">
            <div className="border-b border-slate-800 pb-4">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <User className="w-5 h-5 text-lime-400" /> 1. Basic & Contact Information (Q1-Q4)
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm text-white focus:outline-none focus:border-lime-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm text-white focus:outline-none focus:border-lime-500 mb-2"
                />
                <input
                  type="text"
              ...
              <div className="sm:col-span-2 bg-slate-950/60 p-4 rounded-xl border border-slate-800">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-800 rounded-xl px-3.5 py-2 text-xs text-white focus:outline-none focus:border-lime-500"
                  />
                  <input
                    type="text"
        ...
        {currentStep === 2 && (
          <div className="space-y-6">
            <div className="border-b border-slate-800 pb-4">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <Dumbbell className="w-5 h-5 text-lime-400" /> 2. Physical & Athletic Metrics (Q5-Q9)
              </h2>
        ...
        {currentStep === 3 && (
          <div className="space-y-6">
            <div className="border-b border-slate-800 pb-4">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <ShieldCheck className="w-5 h-5 text-lime-400" /> 3. Verified Combine Performance (Q10-Q14)
              </h2>
        ...
        {currentStep === 4 && (
          <div className="space-y-6">
            <div className="border-b border-slate-800 pb-4">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <BookOpen className="w-5 h-5 text-lime-400" /> 4. Academic Credentials & NCAA Eligibility (Q15-Q18)
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="3.85"
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm font-bold text-lime-400 focus:outline-none focus:border-lime-500"
                />
              </div>
        ...
        {currentStep === 5 && (
          <div className="space-y-6">
            <div className="border-b border-slate-800 pb-4">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <Video className="w-5 h-5 text-lime-400" /> 5. Game Film & Social Handles (Q19-Q21)
              </h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm font-semibold text-cyan-400 focus:outline-none focus:border-lime-500"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm text-cyan-400 focus:outline-none focus:border-lime-500"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm text-pink-400 focus:outline-none focus:border-lime-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-sm text-blue-400 focus:outline-none focus:border-lime-500"
                  />
                </div>
              </div>
            </div>
        ...
        {currentStep === 6 && (
          <div className="space-y-6">
            <div className="border-b border-slate-800 pb-4">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <Award className="w-5 h-5 text-lime-400" /> 6. On-Field Season Stats & Honors (Q22-Q25)
              </h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl p-3 text-sm text-white focus:outline-none focus:border-lime-500"
                />
              </div>
        ...
        {currentStep === 7 && (
          <div className="space-y-6">
            <div className="border-b border-slate-800 pb-4">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <Target className="w-5 h-5 text-lime-400" /> 7. Recruiting Status, Offers & Target Schools (Q26-Q30)
              </h2>
              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1 bg-lime-500 hover:bg-lime-400 text-slate-950 font-bold px-3 py-2 rounded-xl text-xs"
                  >
              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {formData.topTargetSchools.map((school) => (
                    <span key={school} className="inline-flex items-center gap-1.5 px-3 py-1 bg-slate-900 border border-lime-500/30 rounded-full text-xs font-medium text-lime-300">
                      {school}
        ...
        <div className="flex items-center justify-between pt-6 border-t border-slate-800">
          ...
          {currentStep < STEPS.length ? (
            <button
              ...
              className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-lime-500 hover:bg-lime-400 text-slate-950 font-extrabold text-xs transition-all shadow-lg shadow-lime-500/20"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-lime-500 to-teal-400 hover:from-lime-400 hover:to-teal-300 text-slate-950 font-black text-sm transition-all shadow-xl shadow-lime-500/30"
            >
